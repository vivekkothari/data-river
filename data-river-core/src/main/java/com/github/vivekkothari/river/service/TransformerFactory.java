...
public class TransformerFactory {
    ...
    private TransformerFactory(final Map<String, IEnricher> enrichers, final Map<String, IFilter> filters, final Map<String, IBackFiller> backFillers) {
    ...
    @Builder
    public static TransformerFactory transformerFactory(@Singular final Map<String, IEnricher> enrichers, @Singular final Map<String, IFilter> filters,
